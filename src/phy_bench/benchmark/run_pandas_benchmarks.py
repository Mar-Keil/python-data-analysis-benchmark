...
from phy_bench.benchmark.run_pandas import (
...
def main() -> None:
    ...
    run_filter_benchmark(logic_measurement, write_measurement, PANDAS_OUT_DIR)
    run_sort_benchmark(logic_measurement, write_measurement, PANDAS_OUT_DIR)
    run_pivot_benchmark(logic_measurement, write_measurement, PANDAS_OUT_DIR)
    run_group_count_benchmark(logic_measurement, write_measurement, PANDAS_OUT_DIR)
    run_join_benchmark(logic_measurement, write_measurement, PANDAS_OUT_DIR)
