...
ENGINE_CONFIGS: dict[str, EngineConfig] = {
    ...
    "duckdb": create_engine_config(
        ...
        read_for_benchmark=duckdb_logic.read_parquet_materialized,
        read_for_operation=duckdb_logic.read_parquet,
        write_function=duckdb_logic.write_parquet,
        filter_function=duckdb_logic.filter_dataset_materialized,
        sort_function=duckdb_logic.sort_dataset_materialized,
        pivot_function=duckdb_logic.pivot_dataset_materialized,
        group_count_function=duckdb_logic.group_count_dataset_materialized,
        join_function=duckdb_logic.join_dataset_materialized,
    ),
}
